...
parser.add_argument('--save_file', '-sf', type=str, default='supermarket.pt')
...
def test(test_dataset, best_of_n = 1):
	...
	plot_trajectory(past[0].cpu().numpy(), y[0], predicted_future[0], epoch=0, save_dir='./')
...
train_dataset = Supermarket("german_4", hyper_params["past_length"], hyper_params["future_length"], "test")
test_dataset = Supermarket("german_4", hyper_params["past_length"], hyper_params["future_length"], "val")
